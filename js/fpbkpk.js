/**
 * FPB & KPK Studio Controller Module (Standalone Plain JS)
 * Factor Tree Method for PC & Mobile
 */
function initFPBKPKApp() {
...
document.addEventListener('DOMContentLoaded', initFPBKPKApp);
